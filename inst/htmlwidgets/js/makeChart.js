const makeChart = (rdataarray, el, chosen_year, height, svg) => {
  ...
  // create the svg container for our visualization
  // if svg is not null then we have already created the svg
  //   and do not need to create again
  if(svg === null) {
    svg = d3.select(el)
      .append("svg")
  }
  ...
  // return the svg element from this function
  //   so we can attach to our widget to prevent re-creation
  return svg
